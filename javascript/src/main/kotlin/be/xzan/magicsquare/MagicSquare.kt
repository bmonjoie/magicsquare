...
class MagicSquare {
  ...
  private val restart = document.getElementById("restart")
  private val score = document.getElementById("current_score")
  private val best = document.getElementById("best_score")
  ...
  private fun onCheatToggle() {
    cheat = cheatToggle?.checked == true
    if (!cheat) {
      nextCheat = null
      display()
    }
